...
<선택한_감정단어>
${cloudEmotion} ${selectedTags ? `(${selectedTags})` : ''}
</선택한_감정단어>

<대화기록>
${chatSummary || "자신의 감정을 차분히 돌아보며 대화를 나눔"}
</대화기록>

<감정일기>
${diaryText || "오늘 하루 마음속에 스친 생각과 감정을 기록함"}
</감정일기>

<그림_컨텍스트>
${imageDescriptionOrPrompt || "따뜻한 힐링 일러스트"}
</그림_컨텍스트>
...
[최우선 필수 3대 원칙]
★ 1. 없는 내용 지어내지 않기 (학생이 적은 구체적 사건만 사용)
★ 2. 중학교 1학년 특유의 담백한 학생 말투 완벽히 살리기
★ 3. '다 잘될 거야' 같은 억지 긍정 결론 엄격히 금지
