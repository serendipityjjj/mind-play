                      ...
                      <div className="p-2.5 bg-teal-50/70 rounded-xl border border-teal-200 text-xs font-dodum space-y-1">
                        {activityProfile.lesson4.dualLetter.thanksReason && (
                          <p className="text-amber-900">
                            ...
                            {activityProfile.lesson4.dualLetter.thanksBody && <span className="block text-[11px] text-amber-800 font-normal pl-4">{activityProfile.lesson4.dualLetter.thanksBody}</span>}
                          </p>
                        )}
                        {activityProfile.lesson4.dualLetter.sorryAdmit && (
                          <p className="text-teal-900">
                            <strong>💚 인사약:</strong> {activityProfile.lesson4.dualLetter.sorryAdmit}
                            {activityProfile.lesson4.dualLetter.sorryPromise && <span className="block text-[11px] text-teal-800 font-normal pl-4">약속: {activityProfile.lesson4.dualLetter.sorryPromise}</span>}
                          </p>
                        )}
                      </div>
                    </div>
