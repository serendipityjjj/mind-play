  ...
  const [currentLesson, setCurrentLesson] = useState(1);
      ...
      useEffect(() => {
        try {
          ...
          if (savedWorries) setStudentRealWorries(JSON.parse(savedWorries));
        } catch(e){}
      }, [currentUser?.studentId]);

      // 실시간 다중 탭/창 및 학급 데이터 동기화 리스너
      useEffect(() => {
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 pt-1">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (pw === "8888") {
                            ...
                            try { localStorage.setItem("mindplay_johari_partner_assigned", "true"); } catch(e){}
                            triggerConfetti();
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (pw === "8888") {
                            setIsJohariUnlocked(true);
                            try { localStorage.setItem("mindplay_johari_unlocked", "true"); } catch(e){}
                            triggerConfetti();
