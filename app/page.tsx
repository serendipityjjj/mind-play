...
function App() {
  ...
  const [currentLesson, setCurrentLesson] = useState(1);
      ...
      const getAssignedWorryForMe = () => {
        const allWorries = Array.isArray(studentRealWorries) ? studentRealWorries : [];
        ...
        if (allWorries.length > 0) {
          ...
          } else if (allWorries.length === 1 && allWorries[0].studentId === studentId) {
            // 다른 친구가 아직 안 올렸을 때
            return {
              id: "worry_waiting_peer",
              senderTag: "익명 친구의 고민 엽서",
              category: "또래/교우",
              content: "다른 친구들이 사연을 등록하고 있습니다. 잠시 후 새로고침 확인을 눌러주세요.",
              isReal: false
            };
          }
        }
        return {
          ...
          senderTag: "익명 친구의 고민 엽서",
          category: "교우/새 학기",
          content: "아직 등록된 친구의 사연이 없습니다. 친구들이 사연을 올리면 배정됩니다.",
          isReal: false
        };
      };
