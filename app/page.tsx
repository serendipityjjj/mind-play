...
function App() {
  ...
  const [currentLesson, setCurrentLesson] = useState(1);
          ...
          if (savedWorries) {
            try {
              ...
              if (Array.isArray(parsed) && parsed.length > 0) {
                ...
                setStudentRealWorries(DEFAULT_CLASS_STUDENT_WORRIES);
              }
            } catch(e){}
          } else {
            setStudentRealWorries(DEFAULT_CLASS_STUDENT_WORRIES);
        ...
        const pullServerDatabase = async () => {
          try {
            ...
            if (json && json.success && json.data && isMounted) {
              ...
              // 2. 1단계 학생 실시간 사연 동기화
              if (Array.isArray(db.studentRealWorries) && db.studentRealWorries.length > 0) {
      ...
      const [studentRealWorries, setStudentRealWorries] = useState(() => {
        ...
        return DEFAULT_CLASS_STUDENT_WORRIES;
      });
